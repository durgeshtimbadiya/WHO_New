...
open class ContainerConstant {
    ...
    public static func addContainerTo(_ viewController: UIViewController, containerControllers: NSArray, menuIndicatorColor: UIColor, menuItemTitleColor: UIColor, menuItemSelectedTitleColor: UIColor, menuBackGroudColor: UIColor, font: UIFont, menuViewWidth: CGFloat, isSquareBox: Bool) -> ContainerViewController {
