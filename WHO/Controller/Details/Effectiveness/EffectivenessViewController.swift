...
class EffectivenessViewController: UIViewController {
    ...
    func setCellData() {
        ...
        effectiveList.append(EffectivenessModel(image1: EffectivenessString.image4_1, imagePerc1: "22%", imageTitle1: EffectivenessString.imageTitle4_1, image2: EffectivenessString.image4_2, imagePerc2: "28%", imageTitle2: EffectivenessString.imageTitle4_2, content1: EffectivenessString.content4_1_1 + "\n" + EffectivenessString.content4_1_2 + "\n\n" + EffectivenessString.content4_1_3 + "\n\n" + EffectivenessString.content4_1_4))
