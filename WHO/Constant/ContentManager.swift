...
class ContentManager : NSObject {
    ...
    override init() {
        ...
        hypertensionList.append(ConditionProgressModel(progressTitle:EligibilityList.dmpaNet ,progressValS:EligibilityList.num2 ,progressValueF:1 ,subTitle:EligibilityList.progestogenInjectables ,desc:EligibilityList.HypertensionLess160 ,icon:"ic_2" ,isHTML:false ,contraceptualChoicesModel: contraceptiveList[3]))
